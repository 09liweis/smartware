<template>
  <div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
          <div>
            <div class="bg-gray-100 rounded-xl p-8 mb-8">
              <div class="aspect-square bg-gradient-to-br from-blue-900 to-gray-900 rounded-lg mb-6 flex items-center justify-center">
                <div class="text-center text-white">
                  ...
                  <p class="text-lg">{{ featuredProduct.imageLabel }}</p>
                </div>
              </div>
          ...
          <div>
            ...
            <div class="bg-white rounded-xl shadow-lg overflow-hidden">
              <table class="w-full">
                <tbody>
                  <tr
                    v-for="(spec, index) in featuredProduct.specs"
                    :key="spec.label"
                    class="border-b border-gray-200"
                    :class="index % 2 === 1 ? 'bg-gray-50' : ''"
                  >
                    <td class="py-4 px-6 font-semibold text-gray-700">{{ spec.label }}</td>
      ...
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          ...
          <p class="text-gray-600 max-w-2xl mx-auto text-lg">
            Engineered for performance in the toughest environments
          </p>
        </div>
          ...
          >
            <div class="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mb-6">
              <svg class="w-8 h-8 text-blue-600" fill="currentColor" viewBox="0 0 20 20">
                <path :d="feature.iconPath" :fill-rule="feature.fillRule" :clip-rule="feature.clipRule" />
              </svg>
            </div>
    ...
    <section class="py-20">
      <div class="container mx-auto px-4">
        <div class="text-center mb-16">
          <h2 class="text-4xl font-bold mb-6">Related Products</h2>
          <p class="text-gray-600 max-w-2xl mx-auto text-lg">
            Explore our full range of industrial lighting solutions
          </p>
        </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          >
            <div class="h-48" :class="product.gradientClass"></div>
            <div class="p-6">
              <h3 class="text-xl font-bold mb-2">{{ product.name }}</h3>
              <p class="text-gray-600 mb-4">{{ product.tagline }}</p>
              <button class="w-full border-2 border-blue-600 text-blue-600 hover:bg-blue-50 py-2 rounded-lg font-medium transition-colors">
                View Details
              </button>
            </div>
          </div>
...
const featuredProduct = {
  name: 'ApexTower™ Pro-Dual 20,000LM LED Tripod',
  description: 'A heavy-duty, rapid-deploy lighting system designed for 24/7 construction environments. Impact-resistant, weather-proof, and built to last.',
  imageLabel: 'LED Tripod Light',
  specs: [
    { label: 'Brightness', value: '20,000 Lumens' },
    { label: 'Power', value: '150W (AC 110V-240V / DC Battery Compatible)' },
    { label: 'Height', value: 'Telescopic up to 12ft (3.6m)' },
    { label: 'Rating', value: 'IP67 Waterproof / IK08 Impact Rated' },
    { label: 'LED Chip', value: 'Osram™ High-Intensity SMD' },
    { label: 'Color Temperature', value: '5000K Daylight' },
    { label: 'Beam Angle', value: '120° Flood' },
    { label: 'Weight', value: '18kg (40 lbs)' },
  ],
  features: [
    {
      title: 'Wind-Resistant Base',
      description: 'Reinforced tripod legs with anti-slip feet provide exceptional stability on uneven terrain and in high-wind conditions.',
    ...
    {
      title: 'Independent Heads',
      description: 'Dual independent lighting heads with 360° rotation provide total site coverage and precise illumination control.',
    ...
    {
      title: 'Cool-Touch Housing',
      description: 'Advanced thermal management system with integrated heat sinks ensures safe handling during extended operation.',
...
const relatedProducts = [
  {
    name: 'HorizonView™ Light Bar',
    tagline: 'High-precision beam control for fleet vehicles',
    gradientClass: 'bg-gradient-to-br from-gray-800 to-blue-900',
  },
  {
    name: 'ApexTower™ Basic',
    tagline: 'Entry-level tripod for standard applications',
    gradientClass: 'bg-gradient-to-br from-blue-900 to-gray-800',
  },
  {
    name: 'WorkPro™ Flood Light',
    tagline: 'Compact area lighting for job sites',
    gradientClass: 'bg-gradient-to-br from-gray-900 to-blue-800',
  },
]
</script>
